    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agriculturalEngineer', models.BooleanField(default=False)),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to add product.', related_name='custom_users', to='auth.group', verbose_name='groups')),
